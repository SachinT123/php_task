	...
	<div class="info_container">
		...
		<form id="form2" method="POST" enctype="multipart/form-data">
			<fieldset class="data" id="name">
				<legend>Name</legend>
				<input type="text" name="name" class="info" value="<?php echo $row['first_name']." ".$row['last_name'];?>" readonly>
			</fieldset>
			<fieldset class="data" id="email">
				<legend>Email ID</legend>
				<input type="text" name="last_name" class="info" value="<?php echo $row['email']; ?>" readonly>
			</fieldset>
			...
			<fieldset class="data" id="marks">
				<legend>Marks</legend>
				<div id="subjects">
					<p><input type="text" class="info subjectField" name="subject_1" placeholder="Subject_name | Marks" required>
